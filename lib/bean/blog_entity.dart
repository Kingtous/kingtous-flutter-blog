...
class BlogPageable {
  ...
  factory BlogPageable.fromJson(Map<String, dynamic> json) =>
      _$BlogPageableFromJson(json);
...
class BlogPageableSort {
  ...
  factory BlogPageableSort.fromJson(Map<String, dynamic> json) =>
      _$BlogPageableSortFromJson(json);
...
class BlogSort {
  ...
  factory BlogSort.fromJson(Map<String, dynamic> json) =>
      _$BlogSortFromJson(json);
